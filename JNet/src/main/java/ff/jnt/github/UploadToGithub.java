...
//        System.out.println(f.getAbsolutePath() + "----->" + f.exists());
            ...
            String url = "https://api.github.com/repos/hhhaiai/Picture/contents/img/pic.jpg";
            String token = "bf794b9e389826687c655ecfebd50261ce18471e";
...
//		//update(url, file, token);
    ...
    public static boolean create(String url, File file, String token) {
        ...
        try {
            ...
            // 传输json头部
            dos.writeBytes("{\"message\":\"Create By Java\",\"content\":\"");
            // 传输文件内容
