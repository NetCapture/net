...
public class Config {
	...
	public static String owner="hhhaiai";
	public static String repo="Picture";
	public static String path="/img/"; // 想要上传的文件路径，请确保"/"开头，"/"结尾
	public static String token="1e8704dac7b0a5d94116971f012d12732577d3bc";
